...
<main class="table">
        ...
        <section class="table__body" id="customers_table">
            <table>
                <thead>
                    <tr>
                        <th> Violation Id <span class="icon-arrow">&UpArrow;</span></th>
                        <th> Violation Type <span class="icon-arrow">&UpArrow;</span></th>
                       
                        <th> Overdue Date <span class="icon-arrow">&UpArrow;</span></th>
                    ...
                    $sql = "SELECT fine.*, COUNT(payments.fine_id) AS payment_count 
                    FROM fine LEFT JOIN payments ON fine.fine_id = payments.fine_id
                    WHERE fine.licence_no = '$lic_no'
                    GROUP BY fine.fine_id";
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?php if ($payment_count > 0) {
                        echo '<a href="invoice.php?fine_id=' . $row['fine_id'] . '">View</a>';
                    } ?></td>
...
<script >
        const search = document.querySelector('.input-group-table input'),
